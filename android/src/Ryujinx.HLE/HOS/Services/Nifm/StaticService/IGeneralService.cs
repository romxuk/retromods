...
namespace Ryujinx.HLE.HOS.Services.Nifm.StaticService
{
    class IGeneralService : DisposableIpcService
    {
        ...
        public ResultCode GetCurrentNetworkProfile(ServiceCtx context)
        {
            ...
            {
                Logger.Warning?.Print(LogClass.ServiceNifm, "GetCurrentNetworkProfile: no usable IPv4 interface; game has not reached DNS or server connection.");
        ...
        {
            if (PlatformInfo.IsBionic ? GetLocalInterface(context).Item2 == null : !NetworkInterface.GetIsNetworkAvailable())
            {
                return ResultCode.NoInternetConnection;
            }
